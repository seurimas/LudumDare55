...
pub fn store_in_runes<T: Serialize>(t: T, futhark: bool) -> Option<String> {
...
pub fn read_from_runes<T: DeserializeOwned>(runes: &str, futhark: bool) -> Option<T> {
    let bytes = parse_runes(runes, futhark);
    postcard::from_bytes(&bytes).ok()
}

pub fn create_runes<T: Serialize>(t: &T, futhark: bool) -> String {
